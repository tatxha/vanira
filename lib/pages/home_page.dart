              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    // left: -((getScreenWidth(context) - 200) / 2) + 15,
                    // margin carousel + padding + image padding
                    left: (-(getScreenWidth(context)) + (getScreenWidth(context) * 0.5) + 15 + 10 + 10), // Adjust the image position to overlap 10% of its width
                    child: Image.asset(
